...
/*! eHope 1.0 - jQuery plugin 
 * Copyright 2013,Duvan Vargas, @DuvanJamid; Romel Perez, @prhonedev
 * license: www.opensource.org/licenses/mit-license.php
 **/
(function($) {
    eHope = function(data) {
    ...
    eModal = function(data){
        ...
        EMODAL.structure = function(){
            ...
            if(EMODAL.url){
                ...
                emodal_content.html(EMODAL.container.show(0));
            }
            emodal_footer.empty();
